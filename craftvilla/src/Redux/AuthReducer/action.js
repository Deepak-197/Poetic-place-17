...
const register = (payload) => (dispatch) => {
  ...
  console.log(payload);
  return axios
    .post("https://uboric-2bqj.onrender.com/user/signup", payload)        //https://uboric-2bqj.onrender.com/user/signup
    .then((r) => {
...
const login = (params) => (dispatch) => {
  ...
  return axios
    .post("https://uboric-2bqj.onrender.com/user/login", params)    //https://uboric-2bqj.onrender.com/user/login
    .then((r) => {
